-- Omnikai - database schema
-- Run this once in the Supabase dashboard: SQL Editor > New query > paste > Run.
--
-- Written defensively for the Supabase SQL editor:
--   * plain ASCII only (fancy punctuation gets mangled by clipboard encoding)
--   * no dollar-quoting (some editor versions split statements on it);
--     function bodies are single-quoted, so internal quotes are doubled
--
